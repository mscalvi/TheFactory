    ...
    public class UpgradeData
    {
        ...
        internal static readonly Dictionary<string, UpgradeModel> All = new()
        {
            ...
            ["ue01"] = new UpgradeModel
            {
                ...
                UnlockId = "x00",
                MaxBuy = 1,
                PricingId = PricingHelper.PricingId.Expansions0,
                State = UnlockHelper.State.Blocked,
                Persistence = UnlockHelper.Persistence.Permanent,
                TargetId = "x01",
            ...
            ["ut0111"] = new UpgradeModel
            {
                ...
                UnlockId = "t011",
                MaxBuy = 1,
                PricingId = PricingHelper.PricingId.ContractGainT1,
                State = UnlockHelper.State.Blocked,
            ...
            ["ut0112"] = new UpgradeModel
            {
                ...
                UnlockId = "t011",
                MaxBuy = 1,
                PricingId = PricingHelper.PricingId.ContractGainT2,
                State = UnlockHelper.State.Blocked,
                Persistence = UnlockHelper.Persistence.untilExpansion,
                TargetId = "c21",
                EffectType = EffectHelper.EffectType.ContractGain,
            ...
            ["ut0113"] = new UpgradeModel
            {
                ...
                UnlockId = "t011",
                MaxBuy = 1,
                PricingId = PricingHelper.PricingId.ContractGainT4,
                State = UnlockHelper.State.Blocked,
                Persistence = UnlockHelper.Persistence.untilExpansion,
                TargetId = "c44",
                EffectType = EffectHelper.EffectType.ContractGain,
            ...
            ["ut0114"] = new UpgradeModel
            {
                ...
                UnlockId = "t011",
                MaxBuy = 1,
                PricingId = PricingHelper.PricingId.ResourceGainT1,
                State = UnlockHelper.State.Blocked,
                Persistence = UnlockHelper.Persistence.untilExpansion,
                TargetId = "r01",
            ...
            ["ut0215"] = new UpgradeModel
            {
                ...
                UnlockId = "t021",
                MaxBuy = 1,
                PricingId = PricingHelper.PricingId.ContractTimeT1,
                State = UnlockHelper.State.Blocked,
                Persistence = UnlockHelper.Persistence.untilExpansion,
                TargetId = "c12",
                EffectType = EffectHelper.EffectType.ContractTime,
            ...
            ["ut0224"] = new UpgradeModel
            {
                ...
                UnlockId = "t022",
                MaxBuy = 1,
                PricingId = PricingHelper.PricingId.ContractTimeT2,
                State = UnlockHelper.State.Blocked,
                Persistence = UnlockHelper.Persistence.untilExpansion,
                TargetId = "c23",
                EffectType = EffectHelper.EffectType.ContractTime,
            ...
            ["ut0225"] = new UpgradeModel
            {
                ...
                UnlockId = "t022",
                MaxBuy = 1,
                PricingId = PricingHelper.PricingId.ContractTimeT4,
                State = UnlockHelper.State.Blocked,
                Persistence = UnlockHelper.Persistence.untilExpansion,
                TargetId = "c43",
                EffectType = EffectHelper.EffectType.ContractTime,
            ...
            ["ut0311"] = new UpgradeModel
            {
                ...
                UnlockId = "t031",
                MaxBuy = 1,
                PricingId = PricingHelper.PricingId.ContractGainT3,
                State = UnlockHelper.State.Blocked,
                Persistence = UnlockHelper.Persistence.untilExpansion,
                TargetId = "c32",
                EffectType = EffectHelper.EffectType.ContractGain,
            ...
            ["ux001"] = new UpgradeModel
            {
                ...
                UnlockId = "x00",
                MaxBuy = 5,
                PricingId = PricingHelper.PricingId.ContractLevelUnlockEx0,
                State = UnlockHelper.State.Blocked,
                Persistence = UnlockHelper.Persistence.untilExpansion,
                TargetId = "s00",
            ...
            ["ux002"] = new UpgradeModel
            {
                ...
                UnlockId = "x00",
                MaxBuy = 49,
                PricingId = PricingHelper.PricingId.ContractCapUnlockEx0,
                State = UnlockHelper.State.Blocked,
                Persistence = UnlockHelper.Persistence.untilExpansion,
            ...
            ["ux003"] = new UpgradeModel
            {
                ...
                UnlockId = "x00",
                MaxBuy = 4,
                PricingId = PricingHelper.PricingId.ClickGainEx0,
                State = UnlockHelper.State.Blocked,
                Persistence = UnlockHelper.Persistence.untilExpansion,
                TargetId = "s00",
            ...
            ["ux011"] = new UpgradeModel
            {
                ...
                UnlockId = "x01",
                MaxBuy = 1,
                PricingId = PricingHelper.PricingId.ContractGainEx1,
                State = UnlockHelper.State.Blocked,
                Persistence = UnlockHelper.Persistence.untilExpansion,
                TargetId = "aContracts",
            ...
            ["ux012"] = new UpgradeModel
            {
                ...
                UnlockId = "x01",
                MaxBuy = 1,
                PricingId = PricingHelper.PricingId.KnowledgeGainEx1,
                State = UnlockHelper.State.Blocked,
                Persistence = UnlockHelper.Persistence.untilExpansion,
            ...
            ["ux013"] = new UpgradeModel
            {
                ...
                UnlockId = "x01",
                MaxBuy = 1,
                PricingId = PricingHelper.PricingId.ResourceGainEx1,
                State = UnlockHelper.State.Blocked,
                Persistence = UnlockHelper.Persistence.untilExpansion,
                TargetId = "aResources",
            ...
            ["ux021"] = new UpgradeModel
            {
                ...
                UnlockId = "x02",
                MaxBuy = 1,
                PricingId = PricingHelper.PricingId.ContractGainEx2,
                State = UnlockHelper.State.Blocked,
                Persistence = UnlockHelper.Persistence.untilExpansion,
                TargetId = "aContracts",
            ...
            ["ux022"] = new UpgradeModel
            {
                ...
                UnlockId = "x02",
                MaxBuy = 1,
                PricingId = PricingHelper.PricingId.KnowledgeGainEx2,
                State = UnlockHelper.State.Blocked,
                Persistence = UnlockHelper.Persistence.untilExpansion,
                TargetId = "aContracts",
            ...
            ["ux023"] = new UpgradeModel
            {
                ...
                UnlockId = "x02",
                MaxBuy = 1,
                PricingId = PricingHelper.PricingId.ResourceGainEx2,
                State = UnlockHelper.State.Blocked,
                Persistence = UnlockHelper.Persistence.untilExpansion,
                TargetId = "aResources",
