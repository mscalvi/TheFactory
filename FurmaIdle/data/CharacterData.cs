    ...
    public class CharacterData
    {
        ...
        internal static readonly Dictionary<string, CharacterModel> All = new()
        {
            ...
            ["p001"] = new CharacterModel
            {
                ...
                Lore = "",
                Icon = "icons/characters/p001.png",
                Image = "images/characters/p001.png",
                UnlockId = "l00",
            ...
            ["p002"] = new CharacterModel
            {
                ...
                Description = "Artesão",
                Lore = "",
                Icon = "icons/characters/p002.png",
                Image = "images/characters/p002.png",
                UnlockId = "l00",
                State = UnlockHelper.State.Unlocked,
                InStageId = null,
                Persistence = UnlockHelper.Persistence.Permanent,
            ...
            ["p003"] = new CharacterModel
            {
                ...
                Lore = "",
                Icon = "icons/characters/p003.png",
                Image = "images/characters/p003.png",
                UnlockId = "l00",
                State = UnlockHelper.State.Unlocked,
                InStageId = null,
                Persistence = UnlockHelper.Persistence.Permanent,
            ...
            ["p004"] = new CharacterModel
            {
                ...
                Description = "Bardo",
                Lore = "",
                Icon = "icons/characters/p004.png",
                Image = "images/characters/p004.png",
                UnlockId = "up0041",
            ...
            ["p011"] = new CharacterModel
            {
                ...
                Lore = "",
                Icon = "icons/characters/p011.png",
                Image = "images/characters/p011.png",
                UnlockId = "up0051",
            ...
            ["p021"] = new CharacterModel
            {
                ...
                Description = "Caçador",
                Lore = "",
                Icon = "icons/characters/p021.png",
                Image = "images/characters/p021.png",
                UnlockId = "up0061",
                State = UnlockHelper.State.Blocked,
                InStageId = null,
                Persistence = UnlockHelper.Persistence.Permanent,
