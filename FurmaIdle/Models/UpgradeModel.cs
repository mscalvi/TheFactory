...
namespace FurmaIdle.Models
{
    public class UpgradeModel
    {
        ...
        public ItemHelper.ItemType ItemType { get; set; } = ItemHelper.ItemType.Upgrade;
        public ItemHelper.UpgradeSubType UpgradeType { get; set; } = ItemHelper.UpgradeSubType.None;
